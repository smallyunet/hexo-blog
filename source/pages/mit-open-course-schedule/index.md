...
由于现实环境的不可预测性质，课程表不能规定的太严格，但是公开课又太多了，必须保证足够的进度。目前初步按照 <i>课程数 * 1.5</i> 的方式规划每一门课的结束时间，如果在规定时间内没有完成，就需要在接下来的时间里、下一门课正常进行的情况下，补完上一门课。一门课程结束后，需要在接下来 3 天内选出下一门课。不跳过节假日。
