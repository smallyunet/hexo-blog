...
郑重声明：我看不起 “Go 语言 GMP 调度器的原理是什么” 这种技术话题，平时也没兴趣去研究这种问题。

因为在面试中被问到的频率太高了，现在想花 2 个小时的时间来了解下。一方面研究下这个问题背后到底有多大的技术含量，另一方面把这个问题的答案写下来。但是我不会让这些内容停留在我的头脑里，所以下次面试被问到，我肯定还说不会 😏
...
这篇文章肯定有不全面和不到位的地方。我没兴趣进一步深入了，也许有人喜欢折腾这些吧。

如果什么时候，我的工作需要我了解这些内容，才能把工作做好，那么我肯定去把这个东西搞的更明白。
